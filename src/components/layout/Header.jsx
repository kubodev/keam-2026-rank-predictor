...
const Header = ({ onOpenCreatorProfile }) => {
  return (
        ...
        <div className="relative z-10 flex flex-col gap-6">
          <div className="flex items-center justify-between gap-6">
            <div className="max-w-xl">
              ...
              <p className="mt-1 font-heading text-xl text-amber-200 sm:text-2xl">
                by{" "}
                <button
                  type="button"
                  onClick={onOpenCreatorProfile}
                  className="font-heading font-bold underline decoration-amber decoration-2 underline-offset-4 transition hover:text-white"
                >
                  Kubo
                </button>
              </p>
